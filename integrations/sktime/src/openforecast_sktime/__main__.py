"""``python -m openforecast_sktime``: the provider, on stdin and stdout.
...
from openforecast_sktime.provider import SktimeProvider

if __name__ == "__main__":
    raise SystemExit(serve(SktimeProvider()))
