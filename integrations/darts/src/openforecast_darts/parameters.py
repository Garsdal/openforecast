...
Every Darts model takes a different bag of keyword arguments, and a caller needs
two things from an integration about each of them: what may be passed, and why
what they passed was refused. Declaring the parameter once and deriving both
...
whether the model behind it is fitted per series or across all of them.
"""
