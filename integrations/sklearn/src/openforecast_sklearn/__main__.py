"""``python -m openforecast_sklearn``: the provider, on stdin and stdout.
...
from openforecast_sklearn.provider import SklearnProvider

if __name__ == "__main__":
    raise SystemExit(serve(SklearnProvider()))
